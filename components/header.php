    ...
    <div class="category-sidebar" id="categorySidebar">
        ...
        <ul class="category-list">
            ...
            while ($category = $category_result->fetch_assoc()) {
                ...
                // Fetch subcategories
                $subcategory_query = "SELECT name, slug FROM subcategories WHERE category_id = ? AND is_active = 1 ORDER BY sort_order, name";
                ...
                echo '<a href="#" class="category-link" data-category="' . $category_slug . '">';
                ...
                if ($subcategory_result->num_rows > 0) {
                    ...
                    while ($subcategory = $subcategory_result->fetch_assoc()) {
                        ...
                        echo '<li><a href="products.php?subcategory=' . $subcategory_slug . '" class="subcategory-link">' . $subcategory_name . '</a></li>';
                    }
                    echo '</ul>';
                }
                echo '</li>';
